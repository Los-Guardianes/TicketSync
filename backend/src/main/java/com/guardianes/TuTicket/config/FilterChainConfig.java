        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                 ...
                                                 * ================================================
                                                 */
                                                .requestMatchers(HttpMethod.GET, "/api/cliente/{id}")
                                                .hasAnyRole(Rol.CLIENTE.name(), Rol.ORGANIZADOR.name(),
                                                                Rol.ADMINISTRADOR.name())
                                                .requestMatchers("/api/subirImagens3/**")
                                                ...
                                                .requestMatchers(HttpMethod.PUT, "/api/evento/**", "/api/periodo/**",
                                                                "/api/tipoentrada/**", "/api/zona/**",
                                                                "/api/funcion/**", "/api/tarifa/**")
                                                .hasRole(Rol.ORGANIZADOR.name())
                                                .requestMatchers(HttpMethod.DELETE, "/api/periodo/**",
                                                                "/api/tipoentrada/**", "/api/zona/**",
                                                                "/api/funcion/**", "/api/tarifa/**")
                                                .hasRole(Rol.ORGANIZADOR.name())
                                                .requestMatchers(HttpMethod.PATCH, "/api/tarifa/**")
                                                .hasRole(Rol.ORGANIZADOR.name())
                                                .requestMatchers(HttpMethod.PUT, "/api/cliente/{id}", "/api/admin/{id}",
                                                                "/api/organizador/{id}", "/api/params/**")
                                                 ...
                                                 * ================================================
                                                 */
                                                // ✅ FIX: Reglas más específicas primero
                                                 ...
                                                 * ================================================
                                                 */
                                                // ✅ FIX: Reportes - deben estar ANTES de la regla catch-all
                                                .requestMatchers(HttpMethod.GET,
                                                                "/api/organizador/reporte/excel",
                                                                "/api/ingresos/reporte/excel")
                                                .hasRole(Rol.ADMINISTRADOR.name())

                                                .requestMatchers(HttpMethod.GET,
                                                                "/api/evento/*/inscritos/reporte/excel")
                                                .hasRole(Rol.ORGANIZADOR.name())
                                                ...
                                                /*
                                                 * ===============================================
                                                 * 5. Administrador (regla final, si hay alguna específica de rol
                                                 * agregar arriba)
                                                 * ================================================
                                                 */
