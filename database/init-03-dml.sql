...
-- =====================
SELECT tuticket.crear_evento('Concierto Rock Lima', 'Av. Principal 123, Lima', 1, 1, 21, 'SOL'::tipoMoneda, 10, 'Banda internacional', 'Aforo 10k', 'No menores', 'https://ticketsync.s3.us-east-1.amazonaws.com/concierto_rock_lima.jpg', 'maps/rock.png', TRUE);
SELECT tuticket.crear_evento('Teatro Clásico Arequipa', 'Calle Mercaderes 250, Arequipa', 2, 2, 22, 'SOL'::tipoMoneda, 8, 'Obra reconocida', 'Duración 2h', 'No fotos', 'https://ticketsync.s3.us-east-1.amazonaws.com/teatro_clasico_arequipa.jpg', 'maps/teatro.png', TRUE);
SELECT tuticket.crear_evento('Partido Cusco', 'Estadio Garcilaso, Cusco', 3, 3, 23, 'SOL'::tipoMoneda, 10, 'Clásico local', 'Aforo 20k', 'No bebidas', 'img/futbol.jpg', 'https://ticketsync.s3.us-east-1.amazonaws.com/Partido+Cusco.jpg', 'maps/cusco.png', TRUE);
SELECT tuticket.crear_evento('Festival Gastronómico Piura', 'Plaza de Armas, Piura', 4, 4, 24, 'SOL'::tipoMoneda, 6, 'Comida peruana', 'Duración 5h', 'No mascotas', 'https://ticketsync.s3.us-east-1.amazonaws.com/festival_gastronomico_piura.jpg', 'maps/festival.png', TRUE);
SELECT tuticket.crear_evento('Conferencia Tech Trujillo', 'Av. Larco 1010, Trujillo', 5, 5, 25, 'DOLAR'::tipoMoneda, 5, 'Startups 2026', 'Duración 3h', 'Ingreso con ID', 'https://ticketsync.s3.us-east-1.amazonaws.com/conferencia_tech_trujillo.jpg', 'maps/confe.png', TRUE);
SELECT tuticket.crear_evento('Estreno de Cine Tacna', 'Mall Tacna, Tacna', 6, 6, 26, 'SOL'::tipoMoneda, 10, 'Película esperada', 'Duración 2h', 'No grabaciones', 'https://ticketsync.s3.us-east-1.amazonaws.com/estreno_de_cine_tacna.jpeg', 'maps/cine.png', TRUE);
SELECT tuticket.crear_evento('Expo Arte Iquitos', 'Malecón Tarapacá, Iquitos', 7, 7, 27, 'SOL'::tipoMoneda, 8, 'Pinturas modernas', 'Duración 4h', 'No flash', 'https://ticketsync.s3.us-east-1.amazonaws.com/expo_arte_iquitos.jpeg', 'maps/expo.png', TRUE);
SELECT tuticket.crear_evento('Feria Escolar Huancayo', 'Parque Huamanmarca, Huancayo', 8, 8, 28, 'SOL'::tipoMoneda, 10, 'Feria anual', 'Duración 1 día', 'Ingreso libre', 'https://ticketsync.s3.us-east-1.amazonaws.com/feria_escolar_huancayo.jpeg', 'maps/feria.png', TRUE);
SELECT tuticket.crear_evento('Procesión Ayacucho', 'Centro Histórico, Ayacucho', 9, 9, 29, 'SOL'::tipoMoneda, 4, 'Fiesta patronal', 'Duración 6h', 'Ropa adecuada', 'https://ticketsync.s3.us-east-1.amazonaws.com/procesion_huancayo.jpg', 'maps/procesion.png', TRUE);
SELECT tuticket.crear_evento('Encuentro Cultural Puno', 'Plaza de Armas, Puno', 10, 10, 30, 'SOL'::tipoMoneda, 6, 'Danzas andinas', 'Duración 4h', 'Ingreso ordenado', 'https://ticketsync.s3.us-east-1.amazonaws.com/encuentro_cultural_puno.jpeg', 'maps/cultural.png', TRUE);
